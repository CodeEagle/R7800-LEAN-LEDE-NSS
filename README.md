...
| 变量名 | 释义 |
| :--- | :--- |
| -- REPO_URL: https://github.com/coolsnowwolf/lede  | 定义源码 | 
...
## N7800 with NSS 固件下载
网件R7800：[![GitHub release (latest by date)](https://img.shields.io/github/v/release/CodeEagle/R7800-LEAN-LEDE-NSS?style=for-the-badge&label=Download)](https://github.com/CodeEagle/R7800-LEAN-LEDE-NSS/releases/latest)
